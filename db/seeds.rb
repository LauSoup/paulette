...
10.times do
  ...
  description = "#{full_name} is a #{Faker::Job.title} at #{Faker::Company.name}, a company operating in the #{Faker::Company.industry} industry. #{user["results"][0]["name"]["first"]} is originally from the state of #{user["results"][0]["location"]["state"]} and absolutely adores hens."
  password = 'poulette'
